...
module.exports = class StepFunction {
	 ...
	 * @private
	 * @static
	 * @param {ARN} arn The Amazon Resource Name (ARN) of the state machine to execute} arn
	 */

	static validateArn(arn) {
	 ...
	 *
	 * [AWS SDK - StepFunctions.describeExecution]{@link https://docs.aws.amazon.com/AWSJavaScriptSDK/latest/AWS/StepFunctions.html#describeExecution-property}
	 *
	 * @static
	 * @param {ARN} executionArn The execution ARN
	 * @param {import('aws-sdk/clients/stepfunctions').DescribeExecutionInput} params The parameters
	 * @returns {Promise<import('aws-sdk/clients/stepfunctions').DescribeExecutionOutput>}
	 */
	static async describeExecution(executionArn, params) {
