...
### Removed
- `@janiscommerce/aws-secrets-manager` dependency and the `AccountsIdsByService` secret read

## [6.3.1] - 2026-06-19
### Fixed
- `Invoker` async (Event) invocations throwing when the AWS SDK responds without a payload
